...
pub(super) struct QueryCell<Q: Query> {
    output: Arc<Q::Output>,
    idx: usize,
    rev: usize,
    deps: Vec<Dep>
...
pub(super) trait Storage: Any + Send + Sync {
    fn dep_rev(&self, dep: &Dep) -> usize;
    fn as_any(&self) -> &dyn Any;
    fn as_any_mut(&mut self) -> &mut dyn Any;
}

pub(super) struct QueryStorage<Q: Query> {
...
impl<Q: Query> QueryStorage<Q> {
    ...
    pub fn insert(&mut self, query: Q, output: Q::Output, rev: usize, deps: Vec<Dep>) -> QueryCell<Q> {
